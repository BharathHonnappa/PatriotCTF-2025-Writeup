...
A brute-force C program was used to find valid `num`:
...
The third part is compared using `strcmp` with a hardcoded string in `.rodata`. The comparison string was found to be:
...
According to the challenge description and format, the final flag is:
